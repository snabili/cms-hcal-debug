...
c.SaveAs(outfile)
c.SetLogy(False)
m.Draw("et1x1:et2x3>>hist11", "event == 142768944", "COLZ")
r.gDirectory.Get("hist11").SetTitle("HF 2x3 vs 1x1 TP E_{T} for Event 142768944;E_{T} 2x3 TP;E_{T} 1x1 TP")
c.SaveAs(outfile)
m.Draw("et2x3-et1x1>>hist12", "event == 142768944")
r.gDirectory.Get("hist12").SetTitle("HF 2x3 vs 1x1 TP E_{T} for Event 142768944;E_{T} 2x3 TP - E_{T} 1x1 TP;Count")
c.SaveAs(outfile)
m.Draw("et2x3-et1x1>>hist13", "et2x3 >= 127")
r.gDirectory.Get("hist13").SetTitle("HF 2x3 vs 1x1 TP E_{T} for satured 2x3 TP;E_{T} 2x3 TP - E_{T} 1x1 TP;Count")
c.SetLogy()
c.SaveAs(outfile)
m.Draw("et2x3-et1x1>>hist14", "et2x3 < 127")
r.gDirectory.Get("hist14").SetTitle("HF 2x3 vs 1x1 TP E_{T} for unsatured 2x3 TP;E_{T} 2x3 TP - E_{T} 1x1 TP;Count")
c.SaveAs(outfile)
c.SaveAs(outfile + ']')
