...
tps.Draw("soi:abs(ieta)>>histset(12,29.5,41.5,61,-0.5,60.5)", "(version==1) && (fg1 > fg1_emul)", "COLZ")
...
tps.Draw("soi>>histspeca(256,0,256)", "(version==1) && fg1 > fg1_emul", "COLZ")
tps.Draw("soi>>histspecb(256,0,256)", "(version==1) && fg1 < fg1_emul", "COLZ")
tps.Draw("soi>>histspecc(256,0,256)", "(version==1) && fg1 != fg1_emul", "COLZ")
tps.Draw("soi>>histspecd(256,0,256)", "(version==1)", "COLZ")
...
tps.Draw("fg1:fg1_emul>>mismatch", "(version==1) && (fg2_emul>0)", "text COLZ")
r.gDirectory.Get("mismatch").SetTitle("Depth 1 (L1) above threshold;Re-emul FG;L1T FG;")
c.SaveAs(outfile)

tps.Draw("fg1:fg1_emul>>mismatch", "(version==1) && (fg3_emul>0)", "text COLZ")
r.gDirectory.Get("mismatch").SetTitle("Depth 2 (S1) above threshold;Re-emul FG;L1T FG;")
c.SaveAs(outfile)

tps.Draw("fg1:fg1_emul>>mismatch", "(version==1) && (fg4_emul>0)", "text COLZ")
r.gDirectory.Get("mismatch").SetTitle("Depth 3 (L2) above threshold;Re-emul FG;L1T FG;")
c.SaveAs(outfile)

tps.Draw("fg1:fg1_emul>>mismatch", "(version==1) && (fg5_emul>0)", "text COLZ")
r.gDirectory.Get("mismatch").SetTitle("Depth 4 (L3) above threshold;Re-emul FG;L1T FG;")
c.SaveAs(outfile)

tps.Draw("fg1:(fg2_emul+fg3_emul+fg4_emul+fg5_emul)>>hx(5,-0.5,4.5,2,-0.5,1.5)", "(version==1)", "COLZ text");
r.gDirectory.Get("hx").SetTitle(";#sum re-emul FG(depth);L1T FG")
c.SaveAs(outfile)

tps.Draw("fg1_emul:(fg2_emul+fg3_emul+fg4_emul+fg5_emul)>>hx(5,-0.5,4.5,2,-0.5,1.5)", "(version==1)", "COLZ text");
